...
--GPU 0
model_guidance = torch.load('/raid/qingnan/codes/intrinsic/netfiles/model_MPI_main_ImageSplit_reverse_guidance_best_joint.net')
model_intrinsic = torch.load('/raid/qingnan/codes/intrinsic/netfiles/model_MPI_main_ImageSplit_reverse_direct_best_joint.net')
...
postfix = 'MPI_main_ImageSplit_reverse_combine'
max_iters = 10
batch_size = 16
...
local file = '/raid/qingnan/codes/qingnan_codes/train_MPI_main_ImageSplit_reverse_combine.lua'
...
local file = '/raid/qingnan/data/MPI_main_imageSplit-300-test.txt'
local trainSet = {}
local f = io.open(file, "rb")
while true do
  local line = f:read()
...
local file = '/raid/qingnan/data/MPI_main_imageSplit-fullsize-ChenSplit-train.txt'
local testSet = {}
local f = io.open(file, "rb")
while true do
  local line = f:read()
