...
--GPU 0
model_guidance = torch.load('/raid/qingnan/codes/intrinsic/netfiles/model_MPI_main_SceneSplit_front_guidance_best_joint.net')
model_intrinsic = torch.load('/raid/qingnan/codes/intrinsic/netfiles/model_MPI_main_SceneSplit_front_direct_best_joint.net')
...
local file = '/raid/qingnan/codes/qingnan_codes/train_MPI_main_SceneSplit_front_combine.lua'
...
local file = '/raid/qingnan/data/MPI_main_sceneSplit-300-train.txt'
local trainSet = {}
local f = io.open(file, "rb")
while true do
  local line = f:read()
